        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title">
                    <h5><strong>Galeri İşlemleri</strong></h5>
                </div>
            </div>
            <div class="panel-body p-20">
                <p>Yeni galeri oluşturabilir veya varolan bir galeriye ekleme işlemi yapabilirsiniz.
                    Silme, güncelleme, aktiflik/pasiflik, sıralama işlemleri. Bir galeriye ait resimlere ulaşmak için galeri adının üzerine tıklanması yeterlidir.</p>
                <table class="table table-hover table-bordered">
                    ...
                    @foreach($gallery as $item)
                            <tr id="{{$item->id}}" class="subGallery">
                                ...
                                <td>
                                    <a href="{{route('admin.subGallery',$item->id)}}"><i class="fa fa-search"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="panel-body p-5">
                        <form id="frmAddGallery" method="POST" action="{{route('admin.galleryAdd')}}"
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="form-group col-sm-12" style="margin: 5px 0; padding: 5px 0">
                                                    <select style="width: 100%" class="js-example-basic-single"
                                                            id="parentSelect" name="parentSelect">
                                                        <option value="-1" selected>Varolan bir galeri seçiniz</option>
                                                        @foreach($gallery as $item)
                                                            @if($item->parent == 0)
                                                ...
                                                <div class="form-group col-sm-6" style="padding: 0; margin: 0">
                                                    <label for="status">Aktif / Pasif
                                                        <input type="checkbox" id="status" name="status">
                                                    </label>
                                                </div>
                                                <div class="form-group col-sm-6" style="padding: 0; margin: 0">
                                                    <label for="parentCheck">Yeni Galeri
                                                        <input type="checkbox" class="newGallery" name="parentCheck"
                                                               id="parentCheck">
                                                    </label>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="frmUpdateGallery" method="POST" action="{{route('admin.galleryUpdate')}}"
                          enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="number" min="1" max="{{$lastOrder+1}}"
                ...
                if (arr.length > 0)
                {
                    Swal.fire({
                        ...
                        text: "Seçili verileri silmek istediğinize emin misiniz?" +
                            " Not : Seçili galeriye ait alt resimlerde silinecektir",
                        icon: 'warning',
